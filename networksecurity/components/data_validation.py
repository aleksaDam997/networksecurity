    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            if not self.validate_number_of_columns(train_df):
                raise NetworkSecurityException(f"Train data does not have the required number of columns.", sys)

            if not self.validate_number_of_columns(test_df):
                raise NetworkSecurityException(f"Test data does not have the required number of columns.", sys)
